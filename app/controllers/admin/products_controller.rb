module Admin
  class ProductsController < BaseController
    ...
    def product_params
      ...
      params.require(:product).permit(:name, :description, :name_pt, :description_pt, :name_en, :description_en, :name_fr, :description_fr, :name_it, :description_it, :name_de, :description_de, :name_sv, :description_sv, :name_da, :description_da, :cover_image, :active, :stock, :vat_percentage, :auto_carousel, :pack, :schools_only,
