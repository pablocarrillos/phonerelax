module Admin
  class PostsController < BaseController
    ...
    def post_params
      params.require(:post).permit(:title, :slug, :excerpt, :body, :title_pt, :excerpt_pt, :body_pt, :slug_pt, :title_en, :excerpt_en, :body_en, :slug_en, :title_fr, :excerpt_fr, :body_fr, :slug_fr, :title_it, :excerpt_it, :body_it, :slug_it, :title_de, :excerpt_de, :body_de, :slug_de, :title_sv, :excerpt_sv, :body_sv, :slug_sv, :title_da, :excerpt_da, :body_da, :slug_da, :image_url, :published_on)
    end
  end
end
